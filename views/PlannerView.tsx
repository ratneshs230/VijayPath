    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
          <h3 className="text-xl font-bold text-gray-900">{task ? 'Edit Activity' : 'Schedule Activity'}</h3>
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex gap-3">
          ...
          <button
            onClick={handleSave}
            className="flex-1 px-4 py-2 bg-slate-900 text-white text-sm font-bold rounded-lg hover:bg-slate-800 transition shadow-lg disabled:opacity-50"
            disabled={isSaving}
          >
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white p-6 rounded-2xl shadow-sm border border-gray-100 gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Campaign Day Planner</h2>
        ...
        <div className="flex gap-2 bg-slate-100 p-1 rounded-xl">
          ...
          <button
            onClick={goToToday}
            className={`px-6 py-2 rounded-lg text-xs font-black shadow-sm transition ${
              isToday ? 'bg-white text-orange-600' : 'bg-orange-600 text-white hover:bg-orange-700'
            }`}
          >
            Today
          </button>
